...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 15, 2025 at 11:55 AM
...
--
ALTER TABLE `pegawai`
  ADD CONSTRAINT `fk_gol` FOREIGN KEY (`gol`) REFERENCES `gaji` (`gol`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
